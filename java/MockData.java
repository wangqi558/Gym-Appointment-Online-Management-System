...
public class MockData {
    ...
    private void initializeData() {
        // Initialize users
        users = new ArrayList<>();
        users.add(new User("2530034001", "Student 2530034001", "2530034001"));
        users.add(new User("2530034002", "Student 2530034002", "2530034002"));
        users.add(new User("2530034003", "Student 2530034003", "2530034003"));
        users.add(new User("teacher1", "Teacher 1", "1234567893"));
        users.add(new User("teacher2", "Teacher 2", "1234567894"));
        users.add(new User("admin1", "Admin 1", "1234567895"));
        users.add(new User("2530034007", "Student 2530034007", "2530034007"));
        users.add(new User("teacher3", "Teacher 3", "1234567897"));

        // Initialize students
        students = new ArrayList<>();
        students.add(new Student("2530034001"));

        students.add(new Student("2530034002"));

        students.add(new Student("2530034003"));

        students.add(new Student("2530034007"));
        ...
        appointments.add(new Appointment(1, "2530034001", 1, "2024-01-15 10:00", "2024-01-15 12:00", 20.00, "Fitness booking by student with treadmill available"));
        appointments.add(new Appointment(2, "2530034002", 2, "2024-01-16 14:00", "2024-01-16 16:00", 200.00, "Dance room booking - no equipment required"));
        appointments.add(new Appointment(3, "2530034003", 3, "2024-01-17 16:00", "2024-01-17 18:00", 10.00, "Basketball individual booking - courts available"));
        appointments.add(new Appointment(4, "teacher1", 4, "2024-01-18 18:00", "2024-01-18 20:00", 20.00, "Swimming booking - no equipment required"));
        appointments.add(new Appointment(5, "teacher2", 5, "2024-01-19 18:00", "2024-01-19 20:00", 60.00, "Booked Unit: badminton_court2_equipment; Busy-period booking"));
        appointments.add(new Appointment(6, "2530034001", 6, "2024-01-20 15:00", "2024-01-20 17:00", 20.00, "Booked Unit: pingpong_table1_equipment"));
        appointments.add(new Appointment(7, "2530034007", 1, "2024-01-21 09:00", "2024-01-21 11:00", 10.00, "Fitness booking by student with dumbbells available"));
        appointments.add(new Appointment(8, "teacher3", 3, "2024-01-22 19:00", "2024-01-22 21:00", 10.00, "Basketball individual booking by teacher"));

        // Initialize repairs
        repairs = new ArrayList<>();
        repairs.add(new Repair(1, "admin1", "badminton_court3_equipment", "2024-01-10 09:00"));
        repairs.add(new Repair(2, "admin1", "pingpong_table9_equipment", "2024-01-11 14:00"));
        repairs.add(new Repair(3, "admin1", "badminton_court3_equipment", "2024-01-12 16:00"));
    }
...
class Appointment {
    ...
    public Appointment(int appointmentId, String userId, int gymId, String startTime, String endTime, double payment, String record) {
    ...
    public Appointment(int appointmentId, int userId, int gymId, String startTime, String endTime, double payment, String record) {
        this(appointmentId, String.valueOf(userId), gymId, startTime, endTime, payment, record);
    }
...
class Repair {
    ...
    public Repair(int repairId, String adminId, String equipmentId, String timePoint) {
    ...
    public Repair(int repairId, int adminId, String equipmentId, String timePoint) {
        this(repairId, String.valueOf(adminId), equipmentId, timePoint);
    }
